...
import com.carpediem.vv.funny.Adapter.MyGameAdapter;
...
public class MyGameFragment extends BaseFragment {
    ...
    public static MyGameFragment newInstance(String content) {
    ...
    public void initData() {
        ...
        new Thread() {
            @Override
            public void run() {
                ArrayList<Game> gameArrayList = DataParser.getAllGame(1);
    ...
    protected View initView() {
        View view = View.inflate(mActivity, R.layout.fragment_my_game, null);
    ...
    private void initRecyclerView() {
        ...
        mAdapter = new MyGameAdapter(mActivity, arrayList);
