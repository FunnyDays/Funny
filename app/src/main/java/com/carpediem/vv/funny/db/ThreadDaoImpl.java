...
public class ThreadDaoImpl implements ThreadDao {
    ...
    public synchronized void insertThread(ThreadInfo threadInfo) {
        ...
        db.execSQL("insert into thread_info(thread_id,url,start,end,finished,file_length) values(?,?,?,?,?,?)",
                new Object[]{threadInfo.getId(), threadInfo.getUrl(), threadInfo.getStart(), threadInfo.getEnd(), threadInfo.getFinished(),threadInfo.getLength()});
        db.close();
    }
